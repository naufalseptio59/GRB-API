...
router.get('/book/title/:booktitle', controller.getBookByTitle);
router.get('/book/author/:authorname', controller.getBookByAuthor);
router.get('/book/language/:booklanguage', controller.getBookByLanguage);
